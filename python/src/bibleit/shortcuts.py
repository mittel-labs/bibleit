...
BIBLE_VIEW_BINDINGS = [
    ...
    ("ctrl+shift+h", "toggle_listen_history", "Listen History"),
    ("ctrl+shift+r", "toggle_transcripts", "Transcripts"),
    ("ctrl+p", "open_config", "Config"),
    ("ctrl+l", "toggle_live", "Live"),
    ("ctrl+shift+l", "toggle_listening", "Listening"),
...
SHORTCUTS = [
    ...
    ("Ctrl+G", "Strongs"),
    ("Ctrl+H", "History"),
    ("Ctrl+Shift+H", "Listen History"),
    ("Ctrl+Shift+R", "Transcripts"),
    ("Ctrl+P", "Config"),
    ("Ctrl+D", "Toggle theme"),
    ("Ctrl+Shift+L", "Listening mode"),
    ("Ctrl+W", "Close pane"),
