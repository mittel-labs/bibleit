...
class TestBible(unittest.TestCase):
    ...
    def test_ref_invalid(self):
        self.assertEqual(
            self.bible.ref("genesis", "invalid"),
            []
        )

    def test_search(self):
        self.assertEqual(
            self.bible.search("God+created+heaven+earth"),
            [0, 34, 5036, 18488, 18582]
        )

    def test_count(self):
        self.assertEqual(
            self.bible.count("God"),
            4833
        )

    def test_refs_range(self):
        self.assertEqual(
            self.bible.refs(["genesis", "1:1-3"]),
            [
                0, 1, 2
            ]
        )
